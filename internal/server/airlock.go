...
func (a *Airlock) checkConsistency(ctx context.Context, group string, maxSlots uint64) {
	...
	manager, err := lock.NewManager(innerCtx, a.EtcdEndpoints, a.ClientCertPubPath, a.ClientCertKeyPath, a.EtcdUser, a.EtcdPassword, a.EtcdTxnTimeout, group, maxSlots)
	if err != nil {

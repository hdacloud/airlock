...
func (a *Airlock) preRebootHandler(req *http.Request) *herrors.HTTPError {
	...
	defer cancel()
	lockManager, err := lock.NewManager(ctx, a.EtcdEndpoints, a.ClientCertPubPath, a.ClientCertKeyPath, a.EtcdUser, a.EtcdPassword, a.EtcdTxnTimeout, nodeIdentity.Group, slots)
	if err != nil {
